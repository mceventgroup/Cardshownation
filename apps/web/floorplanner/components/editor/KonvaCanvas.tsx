...
import { DEFAULT_NUMBERING_SCHEME } from '@floorplanner/domain/numbering'
...
export default function KonvaCanvas() {
    ...
    for (const tableId of prioritizedTableIds) {
      ...
      dispatch({
        ...
        assignment: {
          ...
          vendorId: vendorId as import('@floorplanner/domain/types').VendorId,
      ...
      if (draft && (draft.x !== startPos.x || draft.y !== startPos.y)) {
        ...
        if (seg) {
          dispatch({
            ...
            segmentId: segmentId as import('@floorplanner/domain/types').RoomSegmentId,
  ...
  const handleBgImageDragEnd = useCallback((id: import('@floorplanner/domain/types').BackgroundImageId, x: number, y: number) => {
          ...
          },
          {
            ...
            action: () => {
              ...
              dispatch({
                ...
                tableIds: ids as import('@floorplanner/domain/types').TableId[],
...
function spatialSort(tables: import('@floorplanner/domain/types').TableObject[]): import('@floorplanner/domain/types').TableObject[] {
...
function selectRangeBetweenTables(
  anchorId: string,
  clickedId: string,
  tables: import('@floorplanner/domain/types').TableObject[],
): import('@floorplanner/domain/types').TableObject[] {
