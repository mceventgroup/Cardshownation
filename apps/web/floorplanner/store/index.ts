...
enableMapSet()
import type { TableObject, Row, Section, Vendor, VendorAssignment, Door, CompositeRoom, LayoutSettings, Point, SectionId, VendorId, RoomSegmentId, RowId, UserId, BackgroundImage, BackgroundImageId } from '@floorplanner/domain/types'
import type { LayoutCommand, CommandHistory } from '@floorplanner/domain/commands'
import { EMPTY_HISTORY } from '@floorplanner/domain/commands'
import type { ImportSession, FieldMapping, ConflictResolution } from '@floorplanner/domain/document'
