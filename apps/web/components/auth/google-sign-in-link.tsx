...
export function GoogleSignInLink({ from = "/account", compact = false }: { from?: string; compact?: boolean }) {
  ...
  return (
    <div className={compact ? "mt-5" : "mt-8"}>
      ...
      <div className={`${compact ? "my-4" : "my-6"} flex items-center gap-3 text-[10px] uppercase tracking-[0.16em] text-slate-400 sm:text-xs sm:tracking-[0.2em]`}>
