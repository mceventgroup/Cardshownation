  ...
  return (
    <LegalPage title="Privacy Policy" summary="This policy explains what information Card Show Nation handles, why we use it, and the choices available to you." updated="September 15, 2026" currentPath="/privacy" sections={sections}>
      ...
      <LegalSection id="sharing" title="5. How information is shared">
        ...
        <p>The homepage uses your saved state to display statewide shows. If you have not selected a state, we send your public IP address from our server to GeoJS to estimate your state, with our hosting provider&apos;s estimate as a fallback. We do not send account information or device GPS coordinates to GeoJS. State lookup results may be held in server memory for up to 15 minutes under a hashed IP identifier; they are not saved to your account or a location cookie. Choosing a state overrides automatic detection and skips this lookup. See <a href="https://www.geojs.io/privacy/" className="font-semibold text-brand-700 underline-offset-4 hover:underline">GeoJS&apos;s privacy policy</a>.</p>
