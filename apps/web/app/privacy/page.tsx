...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy" summary="This policy explains what information Card Show Nation handles, why we use it, and the choices available to you." updated="September 2, 2026" currentPath="/privacy" sections={sections}>
      ...
      <LegalSection id="sharing" title="5. How information is shared">
        <p>We may share information with providers that help us operate the service, including Vercel for hosting and public flyer storage; Neon for database hosting; Resend for email delivery and suppression handling; OpenAI for optional automatic extraction of show details from an uploaded flyer; Stripe for payments; Google for optional sign-in and analytics or advertising; and Meta for optional measurement. Providers process information under their own contracts and privacy terms.</p>
