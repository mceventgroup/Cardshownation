  ...
  return (
    <LegalPage title="Billing Terms" summary="These terms apply to paid Floor Planner subscriptions and supplement the Terms of Use." updated="September 1, 2026" currentPath="/billing-terms" sections={sections}>
      <LegalSection id="plan" title="1. Plan and payment authorization">
        ...
        <p>By subscribing, you authorize Stripe and Card Show Nation to charge the payment method you provide for the initial period and each renewal. Stripe handles payment credentials under its own terms and privacy policy; Card Show Nation receives transaction and subscription status rather than your full card number.</p>
      </LegalSection>
      ...
      <LegalSection id="refunds" title="4. Refunds">
        <p>Subscription charges are generally non-refundable after a billing period begins, except where required by law or when Card Show Nation expressly agrees otherwise. If you believe a charge is incorrect, contact support promptly with the account email and charge date. This policy does not limit any non-waivable consumer rights.</p>
      </LegalSection>
      ...
      <LegalSection id="contact" title="6. Billing support">
        <LegalContact><p className="font-semibold text-slate-950">Questions about a charge or cancellation?</p><p className="mt-1">Email <a href="mailto:support@cardshownation.com" className="font-semibold text-brand-700 underline-offset-4 hover:underline">support@cardshownation.com</a>. Do not send full card numbers or account passwords.</p></LegalContact>
      </LegalSection>
    </LegalPage>
  );
}
